    ...
    if (name !== areaById?.name || capacity !== areaById?.capacity) {
      try {
          ...
          toast.promise(updatePromise, {
            loading: {title: 'Updating', description: 'Please wait while we update Area data.',},
            success: {title: 'Edit Area Successful', description: 'Area data has been updated!', duration: 1000, isClosable: true, onCloseComplete() {navigate(`/admin/crowd-configuration/view/${areaId}`)},},
            error: (error) => ({title: 'Edit Area Failed', description: 'An error occurred during edit Area: ' + error, duration: 5000, isClosable: true}),
          });
        } catch (error) {
          toast({
            ...
            <Stack spacing={4}>
              ...
              >
                ...
                <Button
                  ...
                  onClick={()=>navigate(`/admin/crowd-configuration/view/${areaId}`)}
                >
                  Cancel
                </Button>
                )}
